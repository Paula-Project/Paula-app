...
class TaskItapoaTour extends StatefulWidget {
  final LessonControllerInterface lessonController;
  final TaskItapoaTourModel task;
  const TaskItapoaTour({
    super.key,
  ...
  @override
  State<TaskItapoaTour> createState() => _TaskItapoaTourState();
}

class _TaskItapoaTourState extends State<TaskItapoaTour>
